...
<html lang="en">
  ...
  <body data-pc-preset="preset-1" data-pc-sidebar-theme="light" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme="light">
                      ...
                      <div class="card product-card">
                        <div class="card-img-top">
                          <a href="ecom_product-details.html">
                            <img src=<?= $producto->cover ?> alt="image" class="img-prod img-fluid" />
                          </a>
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex">
                            <div class="flex-shrink-0">
                              <a
                                href="<?= BASE_PATH ?>products/<?= $producto->slug ?>/"
                            ...
                            <div class="flex-grow-1 ms-3">
                              <div class="d-grid">
                                <a href="<?= BASE_PATH ?>products/edit/<?= $producto->slug ?>/" class="btn btn-link-secondary btn-prod-card" >
                                  Editar producto
                                </a>
                                <button onclick="deleteProduct('<?= $producto->id ?>')" type="button" class="btn btn-link-danger btn-prod-card" >Eliminar producto</button>
                              </div>
                            </div>
                          </div>
                        </div>
    ...
    <!-- Form eliminar -->
    <form id="deleteForm" method="POST" action="<?= BASE_PATH ?>products">
