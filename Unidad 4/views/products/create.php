            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Agregar un nuevo producto</h2>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" name="descripcion" placeholder="Introduce la descripción" required></textarea>
                </div>
                <div class="mb-0">
                  <label class="form-label">Características del producto <span class="text-sm text-muted">(Obligatorio)</span></label>
                  <textarea class="form-control" name="caracteristicas" placeholder="Introduce las características" required></textarea>
                </div>
              </div>
            </div>
            <div class="card">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="mb-0">
                  ...
                  <input type="text" name="slug" class="form-control" placeholder="Introduce un Slug"/>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="mb-0">
                  ...
                  <input type="file" id="formFile" name="uploadedfile" class="d-none" required/>
                </div>
              </div>
            </div>
            <div class="card">
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-body text-end btn-page">
                ...
                <button class="btn btn-outline-secondary mb-0">Reiniciar</button>
              </div>
            </div>
          </div>
          <!-- [ sample-page ] end -->
